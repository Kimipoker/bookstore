    ...
    <table width="900" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bordercolordark="#FFFFFF"  bordercolorlight="#888888">
        <tr>
            <td align="center">
                ...
                <table width="100%">
                    <form id="J_form" action="<s:url value="/qamanager_doadd.action"/>" method="post">
                        <tr>
                            <th height="40" align="right" width="40%">所属试题：</th>
                            <td width="60%"><select name="eid" style="width:120px">
                                <s:iterator value="elist" id="f">
                                    <option value="<s:property value="#f.eid"/>"><s:property value="#f.etitle"/></option>
                                </s:iterator>
                            </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="qtitle" id="J_qtitle" /></td>
                        </tr>
                        <tr>
                            <th height="40" align="right">选项A：</th>
                            <td><input type="text" name="a1" id="J_a1"/></td>
                        </tr>
                        <tr>
                            <th height="40" align="right">选项B：</th>
                            <td><input type="text" name="a2" id="J_a2" /></td>
                        </tr>
                        <tr>
                            <th height="40" align="right">选项C：</th>
                            <td><input type="text" name="a3" id="J_a3" /></td>
                        </tr>
                        <tr>
                            <th height="40" align="right">选项D：</th>
                            <td><input type="text" name="a4" id="J_a4" /></td>
                        </tr>
                        <tr>
                            <th height="40" align="right">参考答案：</th>
                            <td><input type="text" name="answer" id="J_answer" /></td>
                        </tr>
                        <tr>
                            <th height="40" align="right">分值：</th>
                            <td><input type="text" name="score" id="J_score" /></td>
                        </tr>
                        <tr>
